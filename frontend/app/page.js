...
export default function Home() {
  return (
    <div className="flex flex-col items-center mt-[10%] font-mono">
      ...
      <button onClick={() => redirect('/homepage')} name="entrar" className="w-42 bg-verde px-12 py-2 rounded m-2">Entrar</button>
      <button onClick={() => redirect('/cadastro')} name="cadastrar" className="hover:underline">Não possui conta? Cadastre-se!</button>
    </div>
  );
}
